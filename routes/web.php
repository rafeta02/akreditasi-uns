...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    // Uraian Logbook
    Route::delete('uraian-logbooks/destroy', 'UraianLogbookController@massDestroy')->name('uraian-logbooks.massDestroy');
    Route::post('uraian-logbooks/parse-csv-import', 'UraianLogbookController@parseCsvImport')->name('uraian-logbooks.parseCsvImport');
    Route::post('uraian-logbooks/process-csv-import', 'UraianLogbookController@processCsvImport')->name('uraian-logbooks.processCsvImport');
    Route::resource('uraian-logbooks', 'UraianLogbookController');
